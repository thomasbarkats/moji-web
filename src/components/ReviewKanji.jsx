              ...
              <table className="w-full">
                <thead>
                  <tr className={`${theme.border} border-b-2`}>
                    <th className={`px-4 py-3 text-left ${theme.text} font-semibold`}>Kanji</th>
                    <th className={`px-4 py-3 text-left ${theme.text} font-semibold`}>Kun</th>
                    <th className={`px-4 py-3 text-left ${theme.text} font-semibold`}>On</th>
                    <th className={`px-4 py-3 text-left ${theme.text} font-semibold`}>Meanings</th>
